			...
			if($row['level']< $currentLevel){
				switch($row['level']){
					...
					case '2':
						...
						break;
					case '3':
						header("Location: Levels/lev31-7x3.php?c@m3_by=2");
						break;
					case '4':
						header("Location: Levels/l3ue1_f0ur~.php?oknow=level4");
						break;
					case '5':
						header("Location: Levels/13vel_Fiu3_1.php?oknow=level5");
						break;
					case '6':
						header("Location: Levels/5ix_1evel_i5_@1l.php?g0t0=l3><e16");
						break;
					case '7':
						header("Location: Levels/l3vE1~_~s3v3n.php?flag_of=4285f4");
						break;
					case '8':
						header("Location: Levels/13v3l_3i68.php?n0w!e=level8");
						break;
					case '9':
						header("Location: Levels/nine_level_is_here.php?gotit=okay");
						break;
					case '10':
						header("Location: Levels/l3vel_10.php?from=nin3");
						break;
					case '11':
						header("Location: Levels/n0w_1ev3l_e1ev3n.php?previous=Level10");
						break;
					default:
						header("../");
						break;
